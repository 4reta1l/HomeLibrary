...
1. Book Management:
o Add new books with details such as title, author, genre, publication year, ISBN, and
number of pages.
...
4. Library Overview:
o Display total number of books, categories, and reading status breakdown (e.g.,
number of unread, reading, or completed books).
